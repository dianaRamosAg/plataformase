    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha', models.DateField(verbose_name='fecha de publicacion')),
                ('nivel_educativo', models.IntegerField(default=1)),
                ('fecha_exa', models.DateField(blank=True, default='2020-06-06')),
                ('lugar_exa', models.CharField(blank=True, default='Algun lugar', max_length=50)),
                ('institucion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='login.UsuarioInstitucion')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
