# Generated by Django 2.2.1 on 2020-06-02 02:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ciclonum', models.IntegerField(blank=True, default='3', null=True)),
                ...
                ('libro_inscripcion', models.IntegerField(blank=True, default='3', null=True)),
                ('fecha', models.DateField(blank=True, default='3', null=True)),
                ('lugar', models.TextField(blank=True, default='3', null=True)),
                ('objeto_social', models.TextField(blank=True, null=True)),
                ('org_cop_acta', models.CharField(blank=True, max_length=2, null=True)),
                ('identificacion', models.TextField(blank=True, null=True)),
                ('org_cop_identificacion', models.CharField(blank=True, max_length=2, null=True)),
                ('folio_id', models.TextField(blank=True, null=True)),
                ('dom_particular', models.TextField(blank=True, null=True)),
                ('celular', models.TextField(blank=True, null=True)),
                ('curp_rfc', models.TextField(blank=True, null=True)),
