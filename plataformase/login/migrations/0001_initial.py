    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('firma_digital', models.ImageField(blank=True, null=True, upload_to='firmas_digitales/')),
                ...
                ('registro', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cct', models.TextField(blank=True, null=True, unique=True)),
